...
public enum EnumTrains {
	...
	locoDieselShunter("Loco Diesel Shunter",EntityLocoDieselShunter.class, 11,ItemIDs.minecartShunter.item,"train_shunter","diesel",800,70,0,70,0,260,0.6,0.94,8000,new String[] {"Blue","Green","Red","Black"},14,new double[]{-2.58,-1.29},null,0.98,1.98),
	...
	/** Electric */
	locoElectricVL10("Loco Electric VL10",EntityLocoElectricVL10.class, 46,ItemIDs.minecartVL10.item,"train_vl10","electric",700,150,0,8,0,400,1.1,0.956,0,null,14,new double[]{-2.5,-1.3},null,0.98,1.98),
	...
	locoElectricSpeedZeroED("Loco Electric High Speed ZeroED",EntityLocoElectricHighSpeedZeroED.class, 12,ItemIDs.minecartLocoHighSpeedZeroED.item,"train_high_speed_loco_zeroed","electric",700,237,0,3,0,230,1.4,0.98,0,null,13,new double[]{-3.4,-1.4},null,0.98,1.98),
	...
	locoElectricTramNY("Loco Electric Tram NY",EntityLocoElectricTramNY.class, 23,ItemIDs.minecartNYTram.item,"train_tram_ny","electric",400,65,0,10,0,170,0.7,0.965,0,null,18,new double[]{-3,-1.3},null,0.98,1.98),
	...
	locoSteamC62Class("Loco Steam C62Class",EntityLocoSteamC62Class.class, 14,ItemIDs.minecartLocoC62Class.item, "train_loco_c62_class","steam",500,129,0,60,180,160,0.7,0.97,10000,null,7,new double[]{-5.66,-4,-2.5,-1.2},null,0.98,1.98),
	locoSteamBR01_DB("Loco Steam BR01",EntityLocoSteamBR01_DB.class, 101,ItemIDs.minecartLocoBR01_DB.item,"train_br01","steam",700,120,0,60,200,300,0.6,0.97,10000,null,10,new double[]{-3.7,-1.97},null,0.98,1.98),
	locoSteamEr_USSR("Loco Steam ER_USSR",EntityLocoSteamEr_Ussr.class, 8,ItemIDs.minecartLocoEr.item,"train_ussr","steam",800,80,0,80,100,200,0.35,0.975,10000,null,10,new double[]{-3.7,-2.5,-1.3},null,0.98,1.98),
	 ...
	 * @param entityClass
	 * @param entityID: Current free IDs: 53,54,55,56,57,58,61,63,64,65,78,79,80,81,82,89,90,91,92,94
	 * @param item
