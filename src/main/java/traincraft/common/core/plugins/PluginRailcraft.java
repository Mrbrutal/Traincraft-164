...
import traincraft.common.items.ItemTrain;
...
public class PluginRailcraft implements IPlugin {
	...
	public boolean isAvailable() {
		return TraincraftCore.isPresent("Railcraft");
	}
	@Override
	...
	private void addTrackRecipes() {
		if(items.containsKey(names[2]) && items.containsKey(names[3]) && items.containsKey(names[4])&&items.containsKey(names[5])&&items.containsKey(names[6])&&items.containsKey(names[7])&&items.containsKey(names[8])){
			...
			if (TrackIDs.ANIMAL_BOARDING_TRACK.getTrackSpec() != null)
				GameRegistry.addRecipe(TrackIDs.ANIMAL_BOARDING_TRACK.getTrackSpec().getItem(TrackIDs.ANIMAL_BOARDING_TRACK.getRecipeOutput()), new Object[] { "#R#", "#X#", "#P#", Character.valueOf('#'), items.get(names[2]), Character.valueOf('R'), items.get(names[8]), Character.valueOf('X'), Item.goldenCarrot, Character.valueOf('P'), Item.enderPearl });
			if (TrackIDs.DISEMBARK_TRACK.getTrackSpec() != null)
				GameRegistry.addRecipe(TrackIDs.DISEMBARK_TRACK.getTrackSpec().getItem(TrackIDs.DISEMBARK_TRACK.getRecipeOutput()), new Object[] { "#R#", "#X#", "# #", Character.valueOf('#'), items.get(names[2]), Character.valueOf('R'), items.get(names[8]), Character.valueOf('X'), Item.shears });
			if (TrackIDs.MOB_BOARDING_TRACK.getTrackSpec() != null)
				GameRegistry.addRecipe(TrackIDs.MOB_BOARDING_TRACK.getTrackSpec().getItem(TrackIDs.MOB_BOARDING_TRACK.getRecipeOutput()), new Object[] { "#R#", "#X#", "#P#", Character.valueOf('#'), items.get(names[2]), Character.valueOf('R'), items.get(names[8]), Character.valueOf('X'), Item.bone, Character.valueOf('P'), Item.enderPearl });
			if (TrackIDs.DETECTOR_ALL_LOCOMOTIVES.getTrackSpec() != null)
			...
			if (TrackIDs.DETECTOR_FREIGHT.getTrackSpec() != null)
				GameRegistry.addRecipe(TrackIDs.DETECTOR_FREIGHT.getTrackSpec().getItem(TrackIDs.DETECTOR_FREIGHT.getRecipeOutput()), new Object[] { "#R#", "#X#", "#E#", Character.valueOf('#'), items.get(names[2]), Character.valueOf('R'), items.get(names[8]), Character.valueOf('X'), Block.chest, Character.valueOf('E'), ItemIDs.electronicCircuit.item });
			if (TrackIDs.DETECTOR_PASSENGER.getTrackSpec() != null)
			...
			if (TrackIDs.DETECTOR_TANK_CARTS.getTrackSpec() != null)
				GameRegistry.addRecipe(TrackIDs.DETECTOR_TANK_CARTS.getTrackSpec().getItem(TrackIDs.DETECTOR_TANK_CARTS.getRecipeOutput()), new Object[] { "#R#", "#X#", "#E#", Character.valueOf('#'), items.get(names[2]), Character.valueOf('R'), items.get(names[8]), Character.valueOf('X'), Item.bucketWater, Character.valueOf('E'), ItemIDs.electronicCircuit.item });
			if (TrackIDs.ENERGY_TRACK.getTrackSpec() != null)
				GameRegistry.addRecipe(TrackIDs.ENERGY_TRACK.getTrackSpec().getItem(TrackIDs.ENERGY_TRACK.getRecipeOutput()), new Object[] { "#X#", "#R#", "#P#", Character.valueOf('#'), items.get(names[2]), Character.valueOf('R'), items.get(names[7]), Character.valueOf('X'), ItemIDs.copperWireFine.item, Character.valueOf('P'), Item.enderPearl});
			if (TrackIDs.STEEL_TRACK.getTrackSpec() != null)
			...
			if (TrackIDs.LOCO_HOLDING_TRACK.getTrackSpec() != null)
				GameRegistry.addRecipe(TrackIDs.LOCO_HOLDING_TRACK.getTrackSpec().getItem(TrackIDs.LOCO_HOLDING_TRACK.getRecipeOutput()), new Object[] { "#R#", "#P#", "#X#", Character.valueOf('#'), ItemIDs.steelRail.item, Character.valueOf('R'), items.get(names[8]), Character.valueOf('X'), ItemIDs.controls.item, Character.valueOf('P'), Block.pressurePlateStone });
			if (TrackIDs.STATION_TRACK.getTrackSpec() != null)
				GameRegistry.addRecipe(TrackIDs.STATION_TRACK.getTrackSpec().getItem(TrackIDs.STATION_TRACK.getRecipeOutput()), new Object[] { "#R#", "#C#", "#R#", Character.valueOf('#'), items.get(names[2]), Character.valueOf('R'), items.get(names[8]), Character.valueOf('C'), Item.pocketSundial});
			if (TrackIDs.HORN_ALL_LOCOMOTIVES.getTrackSpec() != null)
				GameRegistry.addRecipe(TrackIDs.HORN_ALL_LOCOMOTIVES.getTrackSpec().getItem(TrackIDs.HORN_ALL_LOCOMOTIVES.getRecipeOutput()), new Object[] { "#R#", "#S#", "#E#", Character.valueOf('#'), items.get(names[2]), Character.valueOf('R'), items.get(names[8]), Character.valueOf('S'), Item.sign, Character.valueOf('E'), ItemIDs.electronicCircuit.item });
			if (TrackIDs.SNOWY_STEEL_TRACK.getTrackSpec() != null && TrackIDs.STEEL_TRACK.getTrackSpec() != null)
				GameRegistry.addShapelessRecipe(TrackIDs.SNOWY_STEEL_TRACK.getTrackSpec().getItem(TrackIDs.SNOWY_STEEL_TRACK.getRecipeOutput()), new Object[] { TrackIDs.STEEL_TRACK.getTrackSpec().getItem(1),Item.snowball});
			if (TrackIDs.SNOWY_COPPER_TRACK.getTrackSpec() != null && TrackIDs.COPPER_TRACK.getTrackSpec() != null)
				GameRegistry.addShapelessRecipe(TrackIDs.SNOWY_COPPER_TRACK.getTrackSpec().getItem(TrackIDs.SNOWY_COPPER_TRACK.getRecipeOutput()), new Object[] { TrackIDs.COPPER_TRACK.getTrackSpec().getItem(1),Item.snowball});
			if (TrackIDs.VANILLA_SNOWY_TRACK.getTrackSpec() != null)
				GameRegistry.addShapelessRecipe(TrackIDs.VANILLA_SNOWY_TRACK.getTrackSpec().getItem(TrackIDs.VANILLA_SNOWY_TRACK.getRecipeOutput()), new Object[] { Block.rail,Item.snowball});
		}
