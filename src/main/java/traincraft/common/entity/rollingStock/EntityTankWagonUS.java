...
public class EntityTankWagonUS extends LiquidTank {
	...
	public EntityTankWagonUS(World world) {
		super(world, 0, 0, EnumTrains.tankWagonUS.getTankCapacity(), LiquidManager.LAVA_FILTER, true);
		initFreightWater();
	}
	...
	public EntityTankWagonUS(World world, double d, double d1, double d2) {
		this(world);
	...
	public boolean interactFirst(EntityPlayer entityplayer) {
		...
		if (!this.worldObj.isRemote) {
			entityplayer.openGui(Traincraft.instance, GuiIDs.LIQUID, worldObj, this.entityId, -1, (int) this.posZ);
		}
		return true;
	}
