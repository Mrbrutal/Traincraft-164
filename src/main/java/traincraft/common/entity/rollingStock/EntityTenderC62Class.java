...
public class EntityTenderC62Class extends Tender implements IInventory {
	public int freightInventorySize;
	public int numFreightSlots;

	public EntityTenderC62Class(World world) {
		super(world, 0, 0, EnumTrains.tenderC62Class.getTankCapacity(), LiquidManager.WATER_FILTER);
		initFreightTender();
	}
	...
	public EntityTenderC62Class(World world, double d, double d1, double d2) {
		this(world);
	...
	public boolean interactFirst(EntityPlayer entityplayer) {
		...
		if (!this.worldObj.isRemote) {
			entityplayer.openGui(Traincraft.instance, GuiIDs.TENDER, worldObj, this.entityId, -1, (int) this.posZ);
		}
		return true;
	}
