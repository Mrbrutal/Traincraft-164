...
public class EntityFreightCenterbeam_Wood_2 extends Freight implements IInventory {
	...
	public EntityFreightCenterbeam_Wood_2(World world, double d, double d1, double d2) {
		this(world);
