...
public class EntityFreightCenterbeam_Wood_1 extends Freight implements IInventory {
	...
	public EntityFreightCenterbeam_Wood_1(World world, double d, double d1, double d2) {
		this(world);
