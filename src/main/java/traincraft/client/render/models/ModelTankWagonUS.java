...
public class ModelTankWagonUS extends ModelBase {
	...
	public ModelTankWagonUS() {
		...
		box19 = new CustomModelRenderer(110, 78, 128, 128);
		...
		box20 = new CustomModelRenderer(8, 63, 128, 128);
