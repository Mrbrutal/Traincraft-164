...
public class ModelRotaryExcavator extends ModelBase {
	...
	public ModelRotaryExcavator() {
		box8 = new CustomModelRenderer(358, 124, 512, 256);
		box3 = new CustomModelRenderer(102, 65, 512, 256);
		box29 = new CustomModelRenderer(259, 237, 512, 256);
		box11 = new CustomModelRenderer(259, 237, 512, 256);
		box = new CustomModelRenderer(150, 47, 512, 256);
		box35 = new CustomModelRenderer(400, 14, 512, 256);
		box15 = new CustomModelRenderer(3, 8, 512, 256);
		box19 = new CustomModelRenderer(259, 237, 512, 256);
		box23 = new CustomModelRenderer(223, 191, 512, 256);
		box26 = new CustomModelRenderer(259, 237, 512, 256);
		box21 = new CustomModelRenderer(150, 47, 512, 256);
		box2 = new CustomModelRenderer(202, 65, 512, 256);
		box14 = new CustomModelRenderer(17, 41, 512, 256);
		box25 = new CustomModelRenderer(259, 237, 512, 256);
		box28 = new CustomModelRenderer(259, 237, 512, 256);
		box7 = new CustomModelRenderer(223, 191, 512, 256);
		box34 = new CustomModelRenderer(400, 14, 512, 256);
		box27 = new CustomModelRenderer(259, 237, 512, 256);
		box13 = new CustomModelRenderer(259, 237, 512, 256);
		box20 = new CustomModelRenderer(100, 11, 512, 256);
		box32 = new CustomModelRenderer(432, 225, 512, 256);
		box18 = new CustomModelRenderer(78, 167, 512, 256);
		box4 = new CustomModelRenderer(197, 19, 512, 256);
		box22 = new CustomModelRenderer(259, 237, 512, 256);
		box16 = new CustomModelRenderer(29, 21, 512, 256);
		box30 = new CustomModelRenderer(259, 237, 512, 256);
		box6 = new CustomModelRenderer(30, 168, 512, 256);
		box10 = new CustomModelRenderer(223, 191, 512, 256);
		box12 = new CustomModelRenderer(259, 237, 512, 256);
		box9 = new CustomModelRenderer(426, 14, 512, 256);
		box31 = new CustomModelRenderer(357, 124, 512, 256);
		box5 = new CustomModelRenderer(169, 111, 512, 256);
		box24 = new CustomModelRenderer(223, 191, 512, 256);
		box17 = new CustomModelRenderer(78, 167, 512, 256);
		box1 = new CustomModelRenderer(110, 111, 512, 256);
		box33 = new CustomModelRenderer(426, 14, 512, 256);
		box0 = new CustomModelRenderer(259, 237, 512, 256);
