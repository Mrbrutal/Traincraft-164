...
public class ModelFlatCarLogs_DB extends ModelBase {
	...
	public ModelFlatCarLogs_DB() {
		...
		box15 = new CustomModelRenderer(0, 65, 256, 128);
		box15.addBox(0F, 0F, 0F, 2, 19, 1);
		box15.setPosition(19F, 5F, -12F);

		box16 = new CustomModelRenderer(0, 65, 256, 128);
		...
		box18 = new CustomModelRenderer(0, 65, 256, 128);
		box18.addBox(0F, 0F, 0F, 2, 19, 1);
		box18.setPosition(-21F, 5F, -12F);

		box19 = new CustomModelRenderer(0, 65, 256, 128);
		...
		box20 = new CustomModelRenderer(187, 68, 256, 128);
		box20.addBox(0F, 0F, 0F, 1, 5, 16);
		box20.setPosition(-28F, 6F, -8F);

		box21 = new CustomModelRenderer(0, 65, 256, 128);
		box21.addBox(0F, 0F, 0F, 2, 19, 1);
		box21.setPosition(6F, 5F, 11F);

		box22 = new CustomModelRenderer(7, 82, 256, 128);
		box22.addBox(0F, 0F, 0F, 1, 16, 2);
		box22.setPosition(-28F, 11F, -6F);

		box23 = new CustomModelRenderer(7, 82, 256, 128);
		...
		box27 = new CustomModelRenderer(0, 65, 256, 128);
		box27.addBox(0F, 0F, 0F, 2, 19, 1);
		box27.setPosition(-8F, 5F, 11F);

		box28 = new CustomModelRenderer(7, 82, 256, 128);
		box28.addBox(0F, 0F, 0F, 1, 16, 2);
		box28.setPosition(27F, 11F, -6F);

		box29 = new CustomModelRenderer(7, 82, 256, 128);
		...
		box36 = new CustomModelRenderer(141, 112, 256, 128);
		box36.addBox(0F, 0F, 13F, 50, 7, 7);
		box36.setPosition(-25F, 15F, -9F);

		box37 = new CustomModelRenderer(2, 49, 256, 128);
		...
		box39 = new CustomModelRenderer(2, 34, 256, 128);
		...
		box41 = new CustomModelRenderer(12, 68, 256, 128);
