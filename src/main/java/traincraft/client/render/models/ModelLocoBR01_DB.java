...
import traincraft.client.render.models.blocks.ModelRing;
...
public class ModelLocoBR01_DB extends ModelBase {
	...
	public ModelLocoBR01_DB() {
		...
		box0 = new CustomModelRenderer(36, 107, 256, 256);
		...
		box10 = new CustomModelRenderer(104, 25, 256, 256);
		...
		box13 = new CustomModelRenderer(63, 200, 256, 256);
		...
		box14 = new CustomModelRenderer(49, 110, 256, 256);
		box14.addBox(0F, 0F, 0F, 1, 2, 20);
		box14.setPosition(-44F, 15F, -10F);

		box15 = new CustomModelRenderer(36, 84, 256, 256);
		...
		box27 = new CustomModelRenderer(96, 54, 256, 256);
		...
		box28 = new CustomModelRenderer(115, 102, 256, 256);
		...
		box30 = new CustomModelRenderer(96, 54, 256, 256);
		...
		box31 = new CustomModelRenderer(80, 93, 256, 256);
		...
		box32 = new CustomModelRenderer(217, 201, 256, 256);
		box32.addBox(0F, 0F, 0F, 8, 6, 8);
		box32.setPosition(-29F, 28F, -4F);

		box33 = new CustomModelRenderer(142, 106, 256, 256);
		box33.addBox(0F, 0F, 0F, 51, 16, 6);
		box33.setPosition(-47F, 16F, -3F);

		box34 = new CustomModelRenderer(217, 201, 256, 256);
		box34.addBox(0F, 0F, 0F, 8, 6, 8);
		box34.setPosition(-19F, 28F, -4F);

		box35 = new CustomModelRenderer(142, 138, 256, 256);
		box35.addBox(0F, 0F, 0F, 49, 1, 4);
		box35.setPosition(-45F, 17F, 7F);

		box36 = new CustomModelRenderer(139, 48, 256, 256);
		...
		box37 = new CustomModelRenderer(160, 91, 256, 256);
		...
		box38 = new CustomModelRenderer(160, 91, 256, 256);
		...
		box67 = new CustomModelRenderer(151, 184, 256, 256);
		...
		box86 = new CustomModelRenderer(0, 140, 256, 256);
	...
	public void render(Entity entity, float f, float f1, float f2, float f3, float f4, float f5) {
		...
		if(HolidayHelper.isHoliday()) {	
			FMLClientHandler.instance().getClient().renderEngine.bindTexture(new ResourceLocation(Info.resourceLocation, "assets/traincraft/textures/trains/locoBR01_DB_winter.png"));
		}
