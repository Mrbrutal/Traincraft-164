...
public class ModelFlatCarWoodUS extends ModelBase {
	...
	public ModelFlatCarWoodUS() {
		...
		box0 = new CustomModelRenderer(117, 36, 128, 128);
		...
		box20 = new CustomModelRenderer(29, 20, 128, 128);
		box20.addBox(0F, 0F, 0F, 38, 4, 4);
		box20.setPosition(-19F, 13F, -9F);

		box21 = new CustomModelRenderer(26, 45, 128, 128);
		box21.addBox(0F, 0F, 0F, 39, 4, 4);
		box21.setPosition(-20F, 9F, 5F);

		box22 = new CustomModelRenderer(30, 20, 128, 128);
		...
		box24 = new CustomModelRenderer(0, 60, 128, 128);
		...
		box26 = new CustomModelRenderer(26, 45, 128, 128);
		box26.addBox(0F, 0F, 0F, 39, 4, 4);
		box26.setPosition(-20F, 9F, -4F);

		box27 = new CustomModelRenderer(21, 28, 128, 128);
		box27.addBox(0F, 0F, 0F, 41, 4, 4);
		box27.setPosition(-21F, 9F, 1F);

		box28 = new CustomModelRenderer(29, 20, 128, 128);
		box28.addBox(0F, 0F, 0F, 38, 4, 4);
		box28.setPosition(-19F, 13F, -5F);

		box29 = new CustomModelRenderer(26, 45, 128, 128);
		...
		box6 = new CustomModelRenderer(117, 36, 128, 128);
		box6.addBox(0F, 0F, 0F, 1, 16, 1);
		box6.setPosition(12F, 8F, 9F);

		box7 = new CustomModelRenderer(117, 36, 128, 128);
