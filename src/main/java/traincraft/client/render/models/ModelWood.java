...
public class ModelWood extends ModelBase {
	...
	public ModelWood() {
		...
		box35 = new CustomModelRenderer(3, 37, 256, 64);
		...
		box36 = new CustomModelRenderer(109, 2, 256, 64);
		box36.addBox(0F, 0F, 0F, 23, 2, 2);
		box36.setPosition(7F, 6F, -1F);

		box37 = new CustomModelRenderer(108, 7, 256, 64);
		box37.addBox(0F, 0F, 0F, 16, 1, 2);
		box37.setPosition(-8F, 6F, -1F);

		box5 = new CustomModelRenderer(9, 0, 256, 64);
		box5.addBox(0F, 0F, 0F, 3, 2, 22);
		box5.setPosition(-20F, 9F, -11F);

		box6 = new CustomModelRenderer(96, 1, 256, 64);
