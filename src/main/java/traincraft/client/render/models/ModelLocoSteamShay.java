...
public class ModelLocoSteamShay extends ModelBase {
	...
	public ModelLocoSteamShay() {
		boiler_blank_lower = new CustomModelRenderer(1, 180, 256, 256);
		...
		boiler_blank_upper = new CustomModelRenderer(1, 170, 256, 256);
		...
		boiler_piston_lower = new CustomModelRenderer(1, 150, 256, 256);
		...
		boiler_piston_upper = new CustomModelRenderer(1, 160, 256, 256);
		...
		ladder_piston_side = new CustomModelRenderer(221, 121, 256, 256);
		...
		rod_frnt_mid = new CustomModelRenderer(136, 147, 256, 256);
		...
		roof_blank_upper = new CustomModelRenderer(4, 59, 256, 256);
		...
		roof_piston_lower = new CustomModelRenderer(4, 67, 256, 256);
		...
		roof_piston_upper = new CustomModelRenderer(4, 59, 256, 256);
