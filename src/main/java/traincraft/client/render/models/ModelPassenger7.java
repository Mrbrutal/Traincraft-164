...
public class ModelPassenger7 extends ModelBase {
	...
	public ModelPassenger7() {
		...
		box20 = new CustomModelRenderer(18, 107, 256, 128);
		...
		box23 = new CustomModelRenderer(34, 21, 256, 128);
		...
		box4 = new CustomModelRenderer(123, 83, 256, 128);
		box4.addBox(0F, 0F, 0F, 14, 21, 1);
		box4.setPosition(-7F, 9F, -15F);

		box5 = new CustomModelRenderer(151, 1, 256, 128);
		...
		box6 = new CustomModelRenderer(157, 83, 256, 128);
		...
		box7 = new CustomModelRenderer(89, 13, 256, 128);
		...
		box79 = new CustomModelRenderer(6, 92, 256, 128);
