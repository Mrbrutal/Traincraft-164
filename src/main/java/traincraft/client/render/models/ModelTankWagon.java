...
public class ModelTankWagon extends ModelBase {
	...
	public ModelTankWagon() {
		...
		// constructor:
		box = new CustomModelRenderer(0, 20, 256, 256);
		box.addBox(0F, 0F, 0F, 15, 4, 8);
		box.setPosition(7F, 3F, -4F);

		box0 = new CustomModelRenderer(105, 28, 256, 256);
		box0.addBox(0F, 0F, 0F, 4, 2, 4);
		box0.setPosition(-2F, 29F, -2F);

		box1 = new CustomModelRenderer(0, 20, 256, 256);
		box1.addBox(0F, 0F, 0F, 15, 4, 8);
		box1.setPosition(-22F, 3F, -4F);

		box10 = new CustomModelRenderer(156, 173, 256, 256);
		...
		box17 = new CustomModelRenderer(156, 160, 256, 256);
