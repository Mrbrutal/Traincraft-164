...
public class ModelTram extends ModelBase {
	...
	public ModelTram() {
		...
		box20 = new CustomModelRenderer(2, 12, 256, 256);
		...
		box47 = new CustomModelRenderer(130, 51, 256, 256);
		box47.addBox(0F, 0F, 0F, 8, 1, 3);
		box47.setPosition(-23F, 1F, 8F);

		//ok
		box48 = new CustomModelRenderer(31, 52, 256, 256);
		...
		box7 = new CustomModelRenderer(9, 241, 256, 256);
		box7.addBox(0F, 0F, 0F, 10, 5, 1);
		box7.setPosition(7F, 1F, -6F);

		box70 = new CustomModelRenderer(173, 152, 256, 256);
