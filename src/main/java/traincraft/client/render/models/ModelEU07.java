...
public class ModelEU07 extends ModelBase {
	...
	public ModelEU07() {
		...
		box0 = new CustomModelRenderer(139, 74, 256, 128);
		...
		box10 = new CustomModelRenderer(0, 0, 256, 128);
		...
		box19 = new CustomModelRenderer(4, 26, 256, 128);
		...
		box24 = new CustomModelRenderer(165, 15, 256, 128);
		...
		box26 = new CustomModelRenderer(107, 66, 256, 128);
		...
		box27 = new CustomModelRenderer(173, 56, 256, 128);
		box27.addBox(0F, 0F, 0F, 10, 2, 14);
		box27.setPosition(7F, 3F, -7F);

		box28 = new CustomModelRenderer(163, 1, 256, 128);
		box28.addBox(0F, 1F, 0F, 44, 2, 2);
		box28.setPosition(-22F, 11F, 5F);

		box29 = new CustomModelRenderer(163, 1, 256, 128);
		...
		box36 = new CustomModelRenderer(7, 60, 256, 128);
		box36.addBox(0F, 0F, 0F, 6, 2, 1);
		box36.setPosition(-3F, 28F, 10F);

		box37 = new CustomModelRenderer(36, 60, 256, 128);
		...
		box39 = new CustomModelRenderer(23, 60, 256, 128);
		box39.addBox(0F, 0F, 0F, 5, 19, 1);
		box39.setPosition(-8F, 11F, 10F);

		box4 = new CustomModelRenderer(85, 42, 256, 128);
		...
		box41 = new CustomModelRenderer(134, -1, 256, 128);
		...
		box43 = new CustomModelRenderer(36, 106, 256, 128);
		...
		box64 = new CustomModelRenderer(111, 43, 256, 128);
		box64.addBox(0F, 0F, 0F, 18, 3, 0);
		box64.setPosition(-9F, 32F, -6F);

		box7 = new CustomModelRenderer(128, 104, 256, 128);
		box7.addBox(0F, 0F, 0F, 42, 2, 22);
		box7.setPosition(-21F, 9F, -11F);

		box8 = new CustomModelRenderer(165, 15, 256, 128);
		box8.addBox(0F, 0F, 0F, 1, 7, 20);
		box8.setPosition(20F, 11F, -10F);

		box9 = new CustomModelRenderer(136, 83, 256, 128);
