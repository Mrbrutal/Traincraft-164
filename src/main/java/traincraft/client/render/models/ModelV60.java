...
public class ModelV60 extends ModelBase {
	...
	public ModelV60() {
		...
		box19 = new CustomModelRenderer(184, 150, 256, 256);
		...
		box56 = new CustomModelRenderer(245, 168, 256, 256);
		...
		box57 = new CustomModelRenderer(237, 183, 256, 256);
		...
		box58 = new CustomModelRenderer(237, 179, 256, 256);
		...
		box87 = new CustomModelRenderer(233, 173, 256, 256);
		...
		box88 = new CustomModelRenderer(203, 46, 256, 256);
		box88.addBox(0F, 0F, 0F, 2, 0, 22);
		box88.setPosition(8F, 13F, -11F);

		box89 = new CustomModelRenderer(168, 42, 256, 256);
		box89.addBox(0F, 0F, 0F, 4, 2, 22);
		box89.setPosition(-18F, 7F, -11F);

		box9 = new CustomModelRenderer(2, 134, 256, 256);
