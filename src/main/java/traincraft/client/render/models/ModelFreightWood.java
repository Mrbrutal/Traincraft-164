...
public class ModelFreightWood extends ModelBase {
	...
	public ModelFreightWood() {
		...
		box10 = new CustomModelRenderer(100, 0, 256, 128);
		box10.addBox(0F, 0F, 0F, 6, 6, 32);
		box10.setPosition(0F, 9F, -16F);

		box11 = new CustomModelRenderer(100, 38, 256, 128);
		box11.addBox(0F, 0F, 0F, 6, 6, 32);
		box11.setPosition(-6F, 9F, -14F);

		box12 = new CustomModelRenderer(104, 76, 256, 128);
		...
		box3 = new CustomModelRenderer(1, 46, 256, 128);
		box3.addBox(0F, 0F, 0F, 1, 10, 2);
		box3.setPosition(-7F, 9F, 10F);

		box4 = new CustomModelRenderer(1, 46, 256, 128);
		box4.addBox(0F, 0F, 0F, 1, 10, 2);
		box4.setPosition(-7F, 9F, 0F);

		box5 = new CustomModelRenderer(1, 46, 256, 128);
		...
		box6 = new CustomModelRenderer(1, 46, 256, 128);
		...
		box7 = new CustomModelRenderer(1, 46, 256, 128);
		...
		box79 = new CustomModelRenderer(4, 88, 256, 128);
		...
		box9 = new CustomModelRenderer(1, 46, 256, 128);
