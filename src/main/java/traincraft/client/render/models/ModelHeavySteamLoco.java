...
public class ModelHeavySteamLoco extends ModelBase {
	...
	public ModelHeavySteamLoco() {
		box = new CustomModelRenderer(22, 54, 256, 256);
		box.addBox(0F, 0F, 0F, 1, 5, 12);
		box.setPosition(7F, 27F, -6F);

		box0 = new CustomModelRenderer(180, 25, 256, 256);
		box0.addBox(0F, 0F, 0F, 2, 10, 10);
		box0.setPosition(-60F, 19F, -5F);

		box1 = new CustomModelRenderer(0, 117, 256, 256);
		...
		box107 = new CustomModelRenderer(125, 195, 256, 256);
		...
		box108 = new CustomModelRenderer(125, 195, 256, 256);
		...
		box109 = new CustomModelRenderer(124, 169, 256, 256);
		...
		box111 = new CustomModelRenderer(124, 169, 256, 256);
		...
		box112 = new CustomModelRenderer(125, 195, 256, 256);
		...
		box2 = new CustomModelRenderer(1, 24, 256, 256);
		box2.addBox(0F, 0F, 0F, 17, 1, 4);
		box2.setPosition(7F, 32F, -2F);

		box20 = new CustomModelRenderer(91, 41, 256, 256);
		...
		box30 = new CustomModelRenderer(42, 17, 256, 256);
		...
		box36 = new CustomModelRenderer(111, 48, 256, 256);
		...
		box37 = new CustomModelRenderer(112, 78, 256, 256);
		...
		box40 = new CustomModelRenderer(231, 20, 256, 256);
		...
		box48 = new CustomModelRenderer(152, 195, 256, 256);
		...
		box49 = new CustomModelRenderer(187, 205, 256, 256);
		box49.addBox(0F, 0F, 0F, 1, 2, 20);
		box49.setPosition(21F, 9F, -10F);

		box5 = new CustomModelRenderer(152, 195, 256, 256);
		...
		box50 = new CustomModelRenderer(71, 106, 256, 256);
		...
		box51 = new CustomModelRenderer(175, 178, 256, 256);
		...
		box52 = new CustomModelRenderer(175, 178, 256, 256);
		...
		box53 = new CustomModelRenderer(175, 178, 256, 256);
		...
		box54 = new CustomModelRenderer(152, 195, 256, 256);
		...
		box63 = new CustomModelRenderer(0, 42, 256, 256);
		...
		box64 = new CustomModelRenderer(0, 42, 256, 256);
		...
		box73 = new CustomModelRenderer(106, 31, 256, 256);
		...
		box74 = new CustomModelRenderer(130, 10, 256, 256);
		box74.addBox(0F, 0F, 0F, 5, 3, 2);
		box74.setPosition(-1F, 30F, -1F);

		box75 = new CustomModelRenderer(34, 124, 256, 256);
		...
		box8 = new CustomModelRenderer(69, 69, 256, 256);
		...
		box80 = new CustomModelRenderer(219, 186, 256, 256);
		...
		box84 = new CustomModelRenderer(219, 186, 256, 256);
		...
		box87 = new CustomModelRenderer(219, 186, 256, 256);
