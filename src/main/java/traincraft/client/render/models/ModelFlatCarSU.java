...
public class ModelFlatCarSU extends ModelBase {
	...
	public ModelFlatCarSU() {
		...
		box0 = new CustomModelRenderer(3, 7, 128, 128);
		...
		box14 = new CustomModelRenderer(85, 8, 128, 128);
		...
		box4 = new CustomModelRenderer(4, 12, 128, 128);
		box4.addBox(0F, 0F, 0F, 14, 5, 8);
		box4.setPosition(-21F, 3F, -4F);

		box6 = new CustomModelRenderer(0, 32, 128, 128);
		box6.addBox(0F, 0F, 0F, 1, 6, 18);
		box6.setPosition(-24F, 6F, -9F);

		box7 = new CustomModelRenderer(0, 32, 128, 128);
