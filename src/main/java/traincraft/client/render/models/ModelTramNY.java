...
public class ModelTramNY extends ModelBase {
	...
	public ModelTramNY() {
		...
		box113 = new CustomModelRenderer(81, 186, 256, 256);
		...
		box114 = new CustomModelRenderer(81, 186, 256, 256);
		...
		box115 = new CustomModelRenderer(81, 199, 256, 256);
		...
		box116 = new CustomModelRenderer(81, 199, 256, 256);
		...
		box55 = new CustomModelRenderer(90, 164, 256, 256);
		...
		box56 = new CustomModelRenderer(146, 164, 256, 256);
		...
		box57 = new CustomModelRenderer(81, 199, 256, 256);
		...
		box58 = new CustomModelRenderer(48, 168, 256, 256);
		...
		box59 = new CustomModelRenderer(134, 152, 256, 256);
		...
		box6 = new CustomModelRenderer(3, 27, 256, 256);
		box6.addBox(0F, 0F, 0F, 18, 4, 6);
		box6.setPosition(-29F, 3F, -3F);

		box60 = new CustomModelRenderer(124, 152, 256, 256);
		...
		box61 = new CustomModelRenderer(34, 145, 256, 256);
		...
		box68 = new CustomModelRenderer(5, 145, 256, 256);
		...
		box71 = new CustomModelRenderer(117, 164, 256, 256);
		...
		box74 = new CustomModelRenderer(0, 65, 256, 256);
		box74.addBox(0F, 0F, 0F, 66, 2, 20);
		box74.setPosition(-33F, 7F, -10F);

		box75 = new CustomModelRenderer(124, 152, 256, 256);
		...
		box76 = new CustomModelRenderer(114, 152, 256, 256);
		...
		box77 = new CustomModelRenderer(124, 152, 256, 256);
		...
		box78 = new CustomModelRenderer(3, 27, 256, 256);
		box78.addBox(0F, 0F, 0F, 18, 4, 6);
		box78.setPosition(11F, 3F, -3F);

		box79 = new CustomModelRenderer(90, 152, 256, 256);
		...
		box8 = new CustomModelRenderer(1, 55, 256, 256);
		...
		box80 = new CustomModelRenderer(98, 152, 256, 256);
		...
		box81 = new CustomModelRenderer(84, 223, 256, 256);
		...
		box82 = new CustomModelRenderer(84, 216, 256, 256);
		...
		box85 = new CustomModelRenderer(118, 216, 256, 256);
		...
		box86 = new CustomModelRenderer(118, 223, 256, 256);
		...
		box87 = new CustomModelRenderer(142, 223, 256, 256);
		...
		box88 = new CustomModelRenderer(143, 216, 256, 256);
