...
public class ModelMailWagen extends ModelBase {
	...
	public ModelMailWagen() {
		...
		box10 = new CustomModelRenderer(191, 47, 256, 128);
		...
		box12 = new CustomModelRenderer(120, 70, 256, 128);
		...
		box14 = new CustomModelRenderer(172, 84, 256, 128);
		...
		box21 = new CustomModelRenderer(242, 74, 256, 128);
		box21.addBox(0F, 0F, 0F, 1, 18, 4);
		box21.setPosition(27F, 11F, -7F);

		box22 = new CustomModelRenderer(95, 17, 256, 128);
		box22.addBox(0F, 0F, 0F, 1, 5, 16);
		box22.setPosition(27F, 6F, -8F);

		box23 = new CustomModelRenderer(138, 0, 256, 128);
		...
		box26 = new CustomModelRenderer(214, 22, 256, 128);
		box26.addBox(0F, 0F, 0F, 1, 21, 20);
		box26.setPosition(-21F, 10F, -10F);

		box27 = new CustomModelRenderer(125, 60, 256, 128);
		...
		box29 = new CustomModelRenderer(175, 63, 256, 128);
		...
		box30 = new CustomModelRenderer(50, 0, 256, 128);
		...
		box36 = new CustomModelRenderer(125, 60, 256, 128);
		box36.addBox(0F, 0F, 0F, 16, 1, 3);
		box36.setPosition(5F, 1F, 8F);

		box37 = new CustomModelRenderer(214, 84, 256, 128);
		...
		box39 = new CustomModelRenderer(182, 42, 256, 128);
		...
		box41 = new CustomModelRenderer(58, 109, 256, 128);
		...
		box48 = new CustomModelRenderer(212, 1, 256, 128);
		box48.addBox(0F, 0F, 0F, 13, 7, 8);
		box48.setPosition(-8F, 10F, -10F);

		box49 = new CustomModelRenderer(0, 109, 256, 128);
		...
		box60 = new CustomModelRenderer(193, 21, 256, 128);
		...
		box62 = new CustomModelRenderer(27, 12, 256, 128);
