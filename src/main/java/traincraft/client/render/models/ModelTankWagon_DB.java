...
public class ModelTankWagon_DB extends ModelBase {
	...
	public ModelTankWagon_DB() {
		...
		box10 = new CustomModelRenderer(2, 99, 256, 128);
		...
		box24 = new CustomModelRenderer(13, 81, 256, 128);
		...
		box26 = new CustomModelRenderer(13, 81, 256, 128);
		...
		box27 = new CustomModelRenderer(51, 81, 256, 128);
		...
		box29 = new CustomModelRenderer(124, 63, 256, 128);
		...
		box39 = new CustomModelRenderer(2, 80, 256, 128);
		...
		box41 = new CustomModelRenderer(158, 58, 256, 128);
		...
		box46 = new CustomModelRenderer(162, 65, 256, 128);
		...
		box48 = new CustomModelRenderer(178, 47, 256, 128);
		box48.addBox(0F, 0F, 0F, 21, 1, 16);
		box48.setPosition(6F, 9F, -8F);

		box49 = new CustomModelRenderer(156, 67, 256, 128);
		...
		box61 = new CustomModelRenderer(242, 74, 256, 128);
		...
		box7 = new CustomModelRenderer(4, 49, 256, 128);
		...
		box9 = new CustomModelRenderer(2, 39, 256, 128);
