...
public class ModelTenderBR01_DB extends ModelBase {
	...
	public ModelTenderBR01_DB() {
		...
		box59 = new CustomModelRenderer(98, 93, 128, 128);
	...
	public void render(Entity entity, float f, float f1, float f2, float f3, float f4, float f5) {
		...
		if(HolidayHelper.isHoliday()) {	
			FMLClientHandler.instance().getClient().renderEngine.bindTexture(new ResourceLocation(Info.resourceLocation, "assets/traincraft/textures/trains/tenderBR01_DB_winter.png"));
		}
