...
public class ModelLocoSmallSteamEU extends ModelBase {
	...
	public ModelLocoSmallSteamEU() {
		...
		box12 = new CustomModelRenderer(74, 65, 128, 128);
		...
		box26 = new CustomModelRenderer(6, 99, 128, 128);
