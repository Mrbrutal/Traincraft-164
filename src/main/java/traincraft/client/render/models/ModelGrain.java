...
public class ModelGrain extends ModelBase {
	...
	public ModelGrain() {
		...
		box16 = new CustomModelRenderer(248, 98, 256, 128);
		...
		box17 = new CustomModelRenderer(3, 63, 256, 128);
		...
		box2 = new CustomModelRenderer(114, 107, 256, 128);
		box2.addBox(0F, 0F, 0F, 46, 9, 12);
		box2.setPosition(-23F, 0F, -6F);

		box20 = new CustomModelRenderer(235, 101, 256, 128);
		...
		box9 = new CustomModelRenderer(81, 30, 256, 128);
