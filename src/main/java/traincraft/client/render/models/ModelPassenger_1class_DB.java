...
public class ModelPassenger_1class_DB extends ModelBase {
	...
	public ModelPassenger_1class_DB() {
		...
		box = new CustomModelRenderer(172, 39, 256, 128);
		...
		box10 = new CustomModelRenderer(86, 107, 256, 128);
		box10.addBox(0F, 0F, 0F, 42, 19, 1);
		box10.setPosition(-21F, 8F, 10F);

		box11 = new CustomModelRenderer(211, 21, 256, 128);
		box11.addBox(0F, 0F, 0F, 7, 20, 15);
		box11.setPosition(-14F, 10F, -10F);

		box12 = new CustomModelRenderer(175, 62, 256, 128);
		...
		box14 = new CustomModelRenderer(50, 0, 256, 128);
		box14.addBox(0F, 0F, 0F, 6, 17, 1);
		box14.setPosition(21F, 10F, -8F);

		box15 = new CustomModelRenderer(220, 58, 256, 128);
		...
		box22 = new CustomModelRenderer(198, 66, 256, 128);
		...
		box26 = new CustomModelRenderer(214, 84, 256, 128);
		box26.addBox(0F, 0F, 0F, 1, 23, 20);
		box26.setPosition(-21F, 8F, -10F);

		box27 = new CustomModelRenderer(130, 43, 256, 128);
		...
		box29 = new CustomModelRenderer(175, 62, 256, 128);
		...
		box32 = new CustomModelRenderer(175, 62, 256, 128);
		box32.addBox(0F, 0F, 0F, 6, 7, 1);
		box32.setPosition(-6F, 10F, 4F);

		box33 = new CustomModelRenderer(175, 62, 256, 128);
		box33.addBox(0F, 0F, 0F, 6, 7, 1);
		box33.setPosition(13F, 10F, -1F);

		box34 = new CustomModelRenderer(120, 59, 256, 128);
		...
		box36 = new CustomModelRenderer(130, 43, 256, 128);
		box36.addBox(0F, 0F, 0F, 7, 1, 3);
		box36.setPosition(21F, 1F, 7F);

		box37 = new CustomModelRenderer(172, 84, 256, 128);
		...
		box39 = new CustomModelRenderer(124, 75, 256, 128);
		...
		box41 = new CustomModelRenderer(0, 107, 256, 128);
		...
		box44 = new CustomModelRenderer(128, 28, 256, 128);
		...
		box48 = new CustomModelRenderer(114, 3, 256, 128);
		box48.addBox(0F, 0F, 0F, 6, 1, 16);
		box48.setPosition(21F, 9F, -8F);

		box49 = new CustomModelRenderer(125, 49, 256, 128);
		...
		box50 = new CustomModelRenderer(130, 36, 256, 128);
		box50.addBox(0F, 0F, 0F, 6, 1, 3);
		box50.setPosition(21F, 5F, -9F);

		box51 = new CustomModelRenderer(103, 64, 256, 128);
		...
		box52 = new CustomModelRenderer(67, 0, 256, 128);
		box52.addBox(0F, 0F, 0F, 6, 17, 1);
		box52.setPosition(21F, 10F, 7F);

		box53 = new CustomModelRenderer(130, 36, 256, 128);
		...
		box55 = new CustomModelRenderer(153, 50, 256, 128);
		box55.addBox(0F, 0F, 0F, 4, 1, 10);
		box55.setPosition(16F, 26F, -10F);

		box56 = new CustomModelRenderer(187, 51, 256, 128);
		...
		box59 = new CustomModelRenderer(13, 0, 256, 128);
		...
		box60 = new CustomModelRenderer(198, 0, 256, 128);
		...
		box7 = new CustomModelRenderer(13, 0, 256, 128);
