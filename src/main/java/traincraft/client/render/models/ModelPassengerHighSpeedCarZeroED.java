...
public class ModelPassengerHighSpeedCarZeroED extends ModelBase {
	...
	public ModelPassengerHighSpeedCarZeroED() {
		...
		box26 = new CustomModelRenderer(0, 39, 256, 128);
		box26.addBox(0F, 0F, 0F, 17, 5, 14);
		box26.setPosition(-9F, 1F, -6F);

		box27 = new CustomModelRenderer(201, 64, 256, 128);
		...
		box28 = new CustomModelRenderer(201, 64, 256, 128);
		...
		box29 = new CustomModelRenderer(132, 96, 256, 128);
		...
		box38 = new CustomModelRenderer(201, 64, 256, 128);
		...
		box39 = new CustomModelRenderer(132, 96, 256, 128);
		...
		box4 = new CustomModelRenderer(195, 4, 256, 128);
		box4.addBox(0F, 0F, 0F, 8, 7, 0);
		box4.setPosition(-30F, 0F, 5F);

		box40 = new CustomModelRenderer(132, 96, 256, 128);
