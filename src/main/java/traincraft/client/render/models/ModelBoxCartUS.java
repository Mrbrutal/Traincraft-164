...
public class ModelBoxCartUS extends ModelBase {
	...
	public ModelBoxCartUS() {
		...
		box0 = new CustomModelRenderer(0, 34, 128, 128);
		...
		box24 = new CustomModelRenderer(0, 74, 128, 128);
