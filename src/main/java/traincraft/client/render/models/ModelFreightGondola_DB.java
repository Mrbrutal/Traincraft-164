...
public class ModelFreightGondola_DB extends ModelBase {
	...
	public ModelFreightGondola_DB() {
		...
		box16 = new CustomModelRenderer(57, 65, 256, 128);
		...
		box17 = new CustomModelRenderer(57, 65, 256, 128);
		...
		box24 = new CustomModelRenderer(0, 97, 256, 128);
		box24.addBox(0F, 0F, 0F, 52, 10, 20);
		box24.setPosition(-26F, 8F, -10F);
		
		box64 = new CustomModelRenderer(0, 97, 256, 128);
