...
public class ModelFreightClosed extends ModelBase {
	...
	public ModelFreightClosed() {
		...
		box3 = new CustomModelRenderer(151, 57, 256, 128);
		box3.addBox(0F, 0F, 0F, 1, 21, 35);
		box3.setPosition(7F, 9F, -17F);

		box4 = new CustomModelRenderer(115, 68, 256, 128);
		box4.addBox(0F, 0F, 0F, 14, 22, 1);
		box4.setPosition(-7F, 9F, -17F);

		box5 = new CustomModelRenderer(155, 1, 256, 128);
		...
		box6 = new CustomModelRenderer(189, 68, 256, 128);
		...
		box7 = new CustomModelRenderer(97, 0, 256, 128);
		...
		box78 = new CustomModelRenderer(77, 57, 256, 128);
