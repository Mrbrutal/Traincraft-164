...
import traincraft.client.render.models.blocks.ModelLights;
...
public class ModelPassenger6 extends ModelBase {
	...
	public ModelPassenger6() {
		...
		box = new CustomModelRenderer(158, 245, 256, 256);
		box.addBox(0F, 0F, 0F, 10, 4, 4);
		box.setPosition(-9F, 2F, 4F);

		box0 = new CustomModelRenderer(136, 0, 256, 256);
		...
		box12 = new CustomModelRenderer(215, 51, 256, 256);
		...
		box15 = new CustomModelRenderer(1, 67, 256, 256);
		...
		box18 = new CustomModelRenderer(136, 0, 256, 256);
		...
		box61 = new CustomModelRenderer(140, 67, 256, 256);
		...
		box62 = new CustomModelRenderer(145, 67, 256, 256);
		...
		box71 = new CustomModelRenderer(1, 38, 256, 256);
		...
		box82 = new CustomModelRenderer(215, 51, 256, 256);
		...
		box83 = new CustomModelRenderer(199, 122, 256, 256);
		box83.addBox(0F, 0F, 0F, 1, 21, 15);
		box83.setPosition(-10F, 9F, -5F);

		box84 = new CustomModelRenderer(199, 122, 256, 256);
		box84.addBox(0F, 0F, 0F, 1, 21, 15);
		box84.setPosition(9F, 9F, -5F);

		box85 = new CustomModelRenderer(169, 140, 256, 256);
		box85.addBox(0F, 0F, 0F, 0, 21, 20);
		box85.setPosition(-27F, 9F, -10F);

		box86 = new CustomModelRenderer(145, 86, 256, 256);
		...
		box87 = new CustomModelRenderer(213, 140, 256, 256);
		box87.addBox(0F, 0F, 0F, 0, 21, 20);
		box87.setPosition(27F, 9F, -10F);

		box88 = new CustomModelRenderer(217, 71, 256, 256);
