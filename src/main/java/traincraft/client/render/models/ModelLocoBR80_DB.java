...
public class ModelLocoBR80_DB extends ModelBase {
	...
	public void render(Entity entity, float f, float f1, float f2, float f3, float f4, float f5) {
		...
		if(HolidayHelper.isHoliday()) {	
			FMLClientHandler.instance().getClient().renderEngine.bindTexture(new ResourceLocation(Info.resourceLocation, "assets/traincraft/textures/trains/locoBR80_DB_winter.png"));
		}
