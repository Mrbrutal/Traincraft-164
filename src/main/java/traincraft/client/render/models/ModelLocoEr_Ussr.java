...
public class ModelLocoEr_Ussr extends ModelBase {
	...
	public ModelLocoEr_Ussr() {
		...
		body = new CustomModelRenderer(134, 117, 256, 256);
		body.addBox(0F, 0F, 0F, 13, 2, 22);
		body.setPosition(4F, 12F, -11F);

		box = new CustomModelRenderer(70, 69, 256, 256);
		box.addBox(0F, 0F, 0F, 0, 20, 22);
		box.setPosition(4F, 14F, -11F);

		box0 = new CustomModelRenderer(113, 240, 256, 256);
		box0.addBox(0F, 0F, 0F, 2, 3, 4);
		box0.setPosition(-54F, 5F, -2F);

		box1 = new CustomModelRenderer(137, 64, 256, 256);
		box1.addBox(0F, 0F, 0F, 55, 8, 0);
		box1.setPosition(-51F, 15F, 11F);

		box10 = new CustomModelRenderer(80, 76, 256, 256);
		...
		box26 = new CustomModelRenderer(0, 206, 256, 256);
		box26.addBox(0F, -1F, 0F, 4, 1, 3);
		box26.setPosition(18F, 3F, -11F);

		box27 = new CustomModelRenderer(0, 206, 256, 256);
		box27.addBox(0F, 0F, 0F, 4, 1, 3);
		box27.setPosition(18F, 5F, -10F);

		box28 = new CustomModelRenderer(134, 3, 256, 256);
		...
		box33 = new CustomModelRenderer(8, 21, 256, 256);
		box33.addBox(0F, 0F, 0F, 40, 14, 6);
		box33.setPosition(-47F, 16F, -3F);

		box34 = new CustomModelRenderer(0, 0, 256, 256);
		box34.addBox(0F, 0F, 0F, 40, 6, 14);
		box34.setPosition(-47F, 20F, -7F);

		box35 = new CustomModelRenderer(134, 149, 256, 256);
		box35.addBox(0F, 0F, 0F, 3, 4, 4);
		box35.setPosition(-50F, 28F, -2F);

		box36 = new CustomModelRenderer(134, 44, 256, 256);
		...
		box37 = new CustomModelRenderer(77, 237, 256, 256);
		...
		box83 = new CustomModelRenderer(136, 233, 256, 256);
		...
		box9 = new CustomModelRenderer(116, 249, 256, 256);
