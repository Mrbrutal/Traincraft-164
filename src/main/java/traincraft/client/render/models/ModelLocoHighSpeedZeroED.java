...
public class ModelLocoHighSpeedZeroED extends ModelBase {
	...
	public ModelLocoHighSpeedZeroED() {
		...
		box13 = new CustomModelRenderer(0, 72, 256, 256);
		box13.addBox(0F, 0F, 0F, 46, 18, 2);
		box13.setPosition(-12F, 6F, -11F);

		box14 = new CustomModelRenderer(1, 61, 256, 256);
		...
		box32 = new CustomModelRenderer(0, 43, 256, 256);
		...
		box33 = new CustomModelRenderer(162, 22, 256, 256);
		...
		box44 = new CustomModelRenderer(217, 89, 256, 256);
		box44.addBox(0F, 0F, 0F, 1, 20, 18);
		box44.setPosition(-2F, 10F, -9F);

		box45 = new CustomModelRenderer(158, 82, 256, 256);
		...
		box46 = new CustomModelRenderer(187, 84, 256, 256);
		...
		box53 = new CustomModelRenderer(200, 103, 256, 256);
		...
		box57 = new CustomModelRenderer(0, 48, 256, 256);
		...
		box58 = new CustomModelRenderer(0, 52, 256, 256);
		...
		box59 = new CustomModelRenderer(118, 29, 256, 256);
		box59.addBox(0F, 0F, 0F, 10, 2, 6);
		box59.setPosition(14F, 28F, -3F);

		box6 = new CustomModelRenderer(143, 8, 256, 256);
		box6.addBox(0F, 0F, 0F, 16, 3, 1);
		box6.setPosition(-29F, 3F, 5F);

		box60 = new CustomModelRenderer(104, 2, 256, 256);
		...
		box61 = new CustomModelRenderer(107, 6, 256, 256);
		...
		box62 = new CustomModelRenderer(107, 6, 256, 256);
