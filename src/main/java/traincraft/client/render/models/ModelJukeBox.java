...
public class ModelJukeBox extends ModelBase {
	...
	public ModelJukeBox() {
		...
		box1 = new CustomModelRenderer(188, 12, 256, 128);
		...
		box30 = new CustomModelRenderer(81, 37, 256, 128);
		...
		box31 = new CustomModelRenderer(49, 54, 256, 128);
		...
		box35 = new CustomModelRenderer(188, 12, 256, 128);
		...
		box5 = new CustomModelRenderer(188, 12, 256, 128);
		...
		box63 = new CustomModelRenderer(188, 12, 256, 128);
