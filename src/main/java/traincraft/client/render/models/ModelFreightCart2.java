...
public class ModelFreightCart2 extends ModelBase {
	...
	public ModelFreightCart2() {
		box = new CustomModelRenderer(1, 24, 128, 256);
		...
		box20 = new CustomModelRenderer(63, 49, 128, 256);
		...
		box22 = new CustomModelRenderer(63, 49, 128, 256);
		box22.addBox(0F, 0F, 0F, 25, 3, 1);
		box22.setPosition(-6F, 7F, 10F);
		box25 = new CustomModelRenderer(7, 77, 128, 256);
		box25.addBox(0F, 0F, 0F, 3, 2, 2);
		box25.setPosition(-24F, 2F, -1F);
		box28 = new CustomModelRenderer(41, 26, 128, 256);
		...
		box8 = new CustomModelRenderer(1, 96, 128, 256);
		box8.addBox(0F, 0F, 0F, 15, 4, 12);
		box8.setPosition(5F, 1F, -6F);
		box9 = new CustomModelRenderer(63, 49, 128, 256);
