...
public class ModelFlatCarRails_DB extends ModelBase {
	...
	public ModelFlatCarRails_DB() {
		...
		box1 = new CustomModelRenderer(213, 80, 256, 128);
		...
		box39 = new CustomModelRenderer(131, 0, 256, 128);
		...
		box41 = new CustomModelRenderer(131, 0, 256, 128);
		...
		box43 = new CustomModelRenderer(6, 50, 256, 128);
		...
		box7 = new CustomModelRenderer(160, 73, 256, 128);
