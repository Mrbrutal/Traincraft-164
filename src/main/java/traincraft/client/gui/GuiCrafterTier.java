...
import traincraft.client.gui.sideTabs.SideTabInfo;
import traincraft.client.gui.sideTabs.SideTabRecipes;
import traincraft.client.gui.sideTabs.SideTabSlots;
	...
	protected void drawGuiContainerBackgroundLayer(float f, int t, int g) {
		...
		if(currentKnownItem!=null && this.isTabRecipeOpen){
			...
			if(currentRenderTabY==END_Y){
				...
				if(EnumTrains.getEntityWithItem(item, this.mc.theWorld, 0, 0, 0)!=null && item.itemID!=previousItem.itemID){
